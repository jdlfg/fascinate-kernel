...
static long logger_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case LOGGER_FLUSH_LOG:
        ...
        // msjeong DH10 : Audio & PV log dump (FEATURE_SEC_KOREA_MM_PV_LOG) [[--
        case LOGGER_GET_LOGCONFIG:
              ret = log->logconfig;
              break;
        case LOGGER_SET_LOGCONFIG_RESET:
              log->logconfig = 0;
              ret = log->logconfig;
              break;
        case LOGGER_SET_LOGCONFIG_ALL:
              log->logconfig = 0x0000000F;
              ret = log->logconfig;
              break;
        case LOGGER_SET_LOGCONFIG_RIL:
              log->logconfig |= 0x00000001;
              ret = log->logconfig;
              break;
        case LOGGER_SET_LOGCONFIG_AUDIO:
              log->logconfig |= 0x00000002;
              ret = log->logconfig;
              break;
        case LOGGER_SET_LOGCONFIG_PV:
              log->logconfig |= 0x00000004;
              ret = log->logconfig;
              break;
        // msjeong DH10 : Audio & PV log dump --]]
	}
...
DEFINE_LOGGER_DEVICE(log_pv,     LOGGER_LOG_PV,      64*1024)
// msjeong DH10 : Audio & PV log dump --]]
...
static int __init logger_init(void)
{
	...
	plat_log_mark.p_pv = _buf_log_pv;
    // msjeong DH10 : Audio & PV log dump --]]
