...
#define FREQ_COUNT		86337/2 //87084	/*89284*/
...
// 100820 sooo.shin M130L : nStrength = 74% 
	int pwm_duty=FREQ_COUNT/2 + ((FREQ_COUNT/2 - 2) * nForce*74)/12700;
