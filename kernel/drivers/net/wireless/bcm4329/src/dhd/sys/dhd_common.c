...
#define POWERSAVE_RUNTIME_OPTION	// for PowerSaveDisable UI.
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
...
#ifdef POWERSAVE_RUNTIME_OPTION
	struct file *fp = NULL;
	...
	if (fp != NULL && !IS_ERR(fp))
	{
		...
		{
			DHD_ERROR(("[WIFI] Disable Power save and Roaming\n"));
	...
	/* Set PowerSave mode */
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_PM, (char *)&power_mode, sizeof(power_mode));
#endif //POWERSAVE_RUNTIME_OPTION
#endif //BCMDISABLE_PM
	...
	bcm_mkiovar("roam_off", (char *)&dhd_roam_off, 4, iovbuf, sizeof(iovbuf));
	dhdcdc_set_ioctl(dhd, 0, WLC_SET_VAR, iovbuf, sizeof(iovbuf));
