...
#if 1   // Arian-L/K   //VGA check For Factory test
#define V4L2_CID_CHECK_CAM_VGA              (V4L2_CID_PRIVATE_BASE + 61)
#endif
...
enum v4l2_effect_mode {
	...
	IMAGE_EFFECT_RED,					//s1_camera [add effect for vga camera]
	IMAGE_EFFECT_GREEN,				//s1_camera [add effect for vga camera]
	IMAGE_EFFECT_MAX,
};
...
#define V4L2_CID_CAMERA_GPS_PROCESSINGMETHOD	(V4L2_CID_CAMERA_CLASS_BASE+35)		//EUR merge [cts fail]
...
#define V4L2_CID_CAMERA_THUMBNAIL_NULL						(V4L2_CID_PRIVATE_BASE+115)		//eur merge [cts fail]
